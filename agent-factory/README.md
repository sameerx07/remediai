...
| **api-endpoint-creator** | Reads the SHAPE API specification and generates ASP.NET Core controllers, DTOs, validators, service interfaces, and auth policies. 155 endpoints across 17 modules. | [`api-endpoint-creator/api-endpoint-creator.agent.md`](./api-endpoint-creator/api-endpoint-creator.agent.md) |
